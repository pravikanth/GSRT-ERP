<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="ShowAllSubmissions.aspx.cs" Inherits="ShowAllSubmissions" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <asp:Panel ID="Panel1" runat="server" Style="z-index: 1; left: 10px; top: 156px; position: absolute; height: 357px; width: 100%">
            <asp:HyperLink ID="contacts" runat="server" NavigateUrl="~/ConsultantInformation.aspx" Style="z-index: 1; left: 1044px; top: 46px; position: absolute">View Consultants List</asp:HyperLink>
